...
using Hoc_tieng_Nhat_cung_Maruko.View;
using Microsoft.Phone.Controls;
using Microsoft.Phone.Shell;
using CustomMessageBox = Hoc_tieng_Nhat_cung_Maruko.View.CustomMessageBox;
using GestureEventArgs = System.Windows.Input.GestureEventArgs;

namespace Hoc_tieng_Nhat_cung_Maruko
{
    public partial class TestListening : PhoneApplicationPage
    {
        public TestListening()
        {
            InitializeComponent();
            initialize_Questions();
            Loaded += TestListening_Loaded;
            
        }

        void TestListening_Loaded(object sender, RoutedEventArgs e)
        {
